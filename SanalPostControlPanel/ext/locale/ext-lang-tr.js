...
if(Ext.form.VTypes){
	Ext.form.VTypes["emailText"]='Bu alan "user@domain.com" şeklinde elektronik posta formatında olmalıdır';
	Ext.form.VTypes["urlText"]='Bu alan "http://www.domain.com" şeklinde URL adres formatında olmalıdır';
